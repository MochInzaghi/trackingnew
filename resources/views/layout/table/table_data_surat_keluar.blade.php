...
<head>
  ...
  <title>Admin | Table Surat Keluar</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
        <a class="nav-link" data-widget="navbar-search" name="cari" href="#" role="button">
          <i class="fas fa-search"></i>
        </a>
        <div class="navbar-search-block">
          <form class="form-inline" method="GET" action="/admin/data-surat">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Table Data Surat Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.surat')}}">Home</a></li>
              <li class="breadcrumb-item active">Table Data Surat Keluar</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $surat->arsip }}</td>
                    <td>
                    <a href="data-surat/{{ $surat->id }}/verifikasi" class="btn btn-success">Verifikasi</a>
                    <a href="data-surat/{{ $surat->id }}/edit" class="btn btn-primary ml-3">Edit</a>
                    <form class="d-inline ml-3" action = "data_surat/{{ $surat->id }}/delete" method="POST">
                    @csrf
                    @method("delete")
