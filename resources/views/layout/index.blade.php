  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <form class="form-inline" method="GET" action="/admin/index">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <img src="{{asset('template')}}/dist/img/logout.png" style="width: 25px; position= rekative;" alt="User Image">
          <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
              {{ __('Log Out') }}
            </a>
          <form class="d-inline mt-1 ml-2" id="logout-form" action="{{ route('logout') }}" method="POST" class="nav-link">
                @csrf
        </form>
        </div>
      </li>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $surat->seksi }}</td>
                    <td><img src="{{ $surat->takeImage }}/{{ $surat->bukti }}" style="width: 120px;"></td>
                    <td>{{ $surat->file }}</td>
                  </tr>
                  @endforeach
                  </tbody>
